...
@JsonKey(name: 'name') String get cityName;@JsonKey(readValue: _readTemp) double get temperature;@JsonKey(readValue: _readDesc) String get description;@JsonKey(readValue: _readIcon) String get icon;@JsonKey(readValue: _readHumidity) int get humidity;@JsonKey(readValue: _readWind) double get windSpeed;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,cityName,temperature,description,icon,humidity,windSpeed);
...
@useResult
$Res call({
@JsonKey(name: 'name') String cityName,@JsonKey(readValue: _readTemp) double temperature,@JsonKey(readValue: _readDesc) String description,@JsonKey(readValue: _readIcon) String icon,@JsonKey(readValue: _readHumidity) int humidity,@JsonKey(readValue: _readWind) double windSpeed
});
...
/// Create a copy of WeatherModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cityName = null,Object? temperature = null,Object? description = null,Object? icon = null,Object? humidity = null,Object? windSpeed = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'name')  String cityName, @JsonKey(readValue: _readTemp)  double temperature, @JsonKey(readValue: _readDesc)  String description, @JsonKey(readValue: _readIcon)  String icon, @JsonKey(readValue: _readHumidity)  int humidity, @JsonKey(readValue: _readWind)  double windSpeed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WeatherModel() when $default != null:
return $default(_that.cityName,_that.temperature,_that.description,_that.icon,_that.humidity,_that.windSpeed);case _:
  return orElse();
...
class _WeatherModel extends WeatherModel {
  const _WeatherModel({@JsonKey(name: 'name') required this.cityName, @JsonKey(readValue: _readTemp) required this.temperature, @JsonKey(readValue: _readDesc) required this.description, @JsonKey(readValue: _readIcon) required this.icon, @JsonKey(readValue: _readHumidity) required this.humidity, @JsonKey(readValue: _readWind) required this.windSpeed}): super._();
...
/// Create a copy of WeatherModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? cityName = null,Object? temperature = null,Object? description = null,Object? icon = null,Object? humidity = null,Object? windSpeed = null,}) {
